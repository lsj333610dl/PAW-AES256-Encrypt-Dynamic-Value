...
var aes256encrypted = function () {
	this.evaluate = function () {
		var aes256key = this.AES256_KEY
		var enc_test = AES_Encode(this.plainText, aes256key)

		return enc_test;
	}
}

aes256encrypted.identifier = "com.entusapps.AES256Encrypt";
aes256encrypted.title = "AES256 Encrypted";
aes256encrypted.help = "https://github.com/lsj333610dl/PAW-AES256-Encrypt-Dynamic-Value";

aes256encrypted.inputs = [
	InputField("plainText", "Plain Text", "String", {
		placeholder: "Type Plain Text"
	}),
	InputField("AES256_KEY", "Secret Key", "SecureValue", {
		placeholder: "Type Secret Key"
	}),
];

registerDynamicValueClass(aes256encrypted)
// ======PAW-END==========